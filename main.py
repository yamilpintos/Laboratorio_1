...
movies_subset = movies_subset.head(5000)
...
async def recomendacion(titulo: str):
    ...
    genre_movies = movies_subset[movies_subset['genre_name'] == genero]

    title_features = genre_movies[genre_movies['title'] == titulo].drop(
        'title', axis=1)
